...
Congratulations: Auto-sent when client completes all payments — includes 6 PDF attachments:
Certificado de pago total
Planos arquitectónicos completos (según modelo asignado)
Planos estructurales
Diseño de redes hidráulicas y sanitarias
Diseño eléctrico
Aprobación para licencia de construcción
Model assignment: Based on lot area (>=150m² → El Nogal, >=120m² → El Roble, <120m² → El Cedro)
Password reset: Sent via forgot-password flow with token link (1hr expiry)
Technical document generation: server/technical-docs.ts
...
Run database.sql to create tables and seed data
